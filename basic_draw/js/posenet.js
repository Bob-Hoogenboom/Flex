...
function showSkeleton(poseArray){
    ...
    if(poseArray.keypoints[0].score>0.8){// see the nose? pobability > 80%
      ...
      ellipse(poseArray.keypoints[0].position, 15, 'blue'); // coordinates nose, draw circle
      ellipse(poseArray.keypoints[1].position, 10, 'cyan'); // coordinates leftEye, draw circle
      ellipse(poseArray.keypoints[2].position, 10, 'cyan'); // coordinates rightEye, draw circle
